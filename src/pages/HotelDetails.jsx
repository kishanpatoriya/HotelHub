    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5 mb-6">
          ...
          <button className="border border-gray-300 bg-white px-5 py-2.5 rounded-lg hover:bg-gray-100 transition">
            ❤️ Save
          </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-8">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-gray-600 mt-3 text-sm leading-6">
                Amazing hotel with clean rooms and friendly staff.
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-gray-600 mt-3 text-sm leading-6">
                Very comfortable stay. The room was spacious and
